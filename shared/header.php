<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="design/style.css?v=3"/>
        <!--Google Icons-->
    ...
    <body>
        <header class="header-nav">
            <h1 class="header-name">Library System</h1>
            <nav>
                <a class="btn" href="http://">Books</a>
                <a class="btn" href="http://">Theses</a>
